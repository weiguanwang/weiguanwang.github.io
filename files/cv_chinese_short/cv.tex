...
\cvlistitem{\underline{Weiguan Wang}, Jia Xu. Machine learning option price movement, \textbf{Risks}, 2024, 12(6), 93}


\cvlistitem{王伟冠，刘鑫. 基于线性回归和神经网络的期权对冲方法：以上证50ETF期权为例. \textbf{上海大学学报}}

\subsection{在投论文}


\cvlistitem{Jie Mao, Jingjing Shao,  and \underline{Weiguan Wang}, Risk premium principal components for the Chinese stock market. (\textbf{Pacific-Basin Finance Journal}, 返修中) 
}
